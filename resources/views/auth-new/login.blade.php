<html lang="en" dir="rtl"><!--<![endif]--><!-- BEGIN HEAD --><head>
    ...
    <link href="dashboard/assets/global/plugins/bootstrap/css/bootstrap-rtl.min.css" rel="stylesheet" type="text/css">
    <link href="dashboard/assets/global/plugins/bootstrap-switch/css/bootstrap-switch-rtl.min.css" rel="stylesheet" type="text/css">
    ...
    <link href="dashboard/assets/global/css/components-md-rtl.min.css" rel="stylesheet" id="style_components" type="text/css">
    <link href="dashboard/assets/global/css/plugins-md-rtl.min.css" rel="stylesheet" type="text/css">
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="dashboard/assets/pages/css/login-rtl.min.css" rel="stylesheet" type="text/css">
...
<body class=" login">
    ...
    <div class="logo">
        <a href="index.html">
            <img src="dashboard/assets/pages/img/logo-big.png" alt=""> </a>
    </div>
    <!-- END LOGO -->
    <!-- BEGIN LOGIN -->
    <div class="content">
...
<![endif]-->
    ...
    <script src="dashboard/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
    <script src="dashboard/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL PLUGINS -->
    <!-- BEGIN THEME GLOBAL SCRIPTS -->
    <script src="dashboard/assets/global/scripts/app.min.js" type="text/javascript"></script>
    <!-- END THEME GLOBAL SCRIPTS -->
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="dashboard/assets/pages/scripts/login.min.js" type="text/javascript"></script>
