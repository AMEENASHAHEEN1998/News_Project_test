<html lang="en"><head>
  ...
  <script src="https://code.iconify.design/2/2.1.2/iconify.min.js"></script>
   <link rel="stylesheet" href="{{ asset('site/newsCategory/style.css') }}">
      <!-- fontawesome -->
  ...
  .background{
  height:23rem;
  background:url("{{ asset('site/newsCategory/background.png') }}") no-repeat center;
  ...
  <body>
         ...
         <nav>
              <div class="logo">
                  <img src="{{ asset('site/newsCategory/img1.png') }}" alt="" id="img1">
              </div>
              <div class="toggle">
      ...
      <div class="header01">
       ...
       <footer class="">
          <div class="footer">
  <div>
  <img src="{{ asset('site/newsCategory/logo.png') }}" id="logo" style="height:20">
